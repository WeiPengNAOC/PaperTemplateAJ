...
%%
%% This is a samzhang2012legueple manuscript marked up using the
%% AASTeX v5.x LaTeX 2e macros.

%% The first piece of markup in an AASTeX v5.x document
%% is the \documentclass command. LaTeX will ignore
%% any data that comes before this comwhitney1983principalmand.
...
\newcommand{\myemail}{weipeng@nao.cas.cn}
...
%%we add this package to support the author's chinese names
%\usepackage{ctex}
...
\author{Peng Wei\altaffilmark{1, 2}, Ali Luo*\altaffilmark{1, 3}, Yinbi Li\altaffilmark{1} , Liangping Tu \altaffilmark{1, 4}, Fengfei Wang\altaffilmark{1}, Jiannan Zhang\altaffilmark{1}, Xiaoyan Chen \altaffilmark{1}, Wen Hou\altaffilmark{1, 2}, Xiao Kong\altaffilmark{1, 2},Yue Wu \altaffilmark{1},Fang Zuo \altaffilmark{1}}
...
\author{Jingchang Pan\altaffilmark{3},Bin Jiang \altaffilmark{3},Jie Liu\altaffilmark{3}, Zhenping Yi\altaffilmark{1, 2, 3} }
\affil{School of Mechanical,  Electrical and Information Engineering,  Shandong University, Weihai,  264209,  China}

\author{Yongheng Zhao\altaffilmark{1}, Jianjun Chen\altaffilmark{1, 2}, Bing Du\altaffilmark{1}, Yanxin Guo\altaffilmark{1},  Juanjuan Ren\altaffilmark{1, 2}, Yihan Song\altaffilmark{1}, Mengxin Wang \altaffilmark{1}, Kefei Wu\altaffilmark{1},Haifeng Yang\altaffilmark{1, 2, 5}, }
\affil{Key Laboratory of Optical Astronomy, National Astronomical Observatories,   Chinese Academy of Sciences,  Beijing,  100012,  China}
...
\begin{abstract}
The LAMOST spectra analysis pipeline,
so called 1D pipeline,
aims to classify and measure the spectra observed in LAMOST survey.
...
we initially obtain  216 stellar template spectra.
We visually inspect all template spectra,
and 29 spectra are abandoned due to low spectral quality.
Furthermore, the MK classification for the remaining 187 template spectrum is manually determined by comparing with three template libraries.
Meanwhile, 10 template spectra whose subclass is difficult to determine are abandoned.
Finally, we obtain a new template library containing 183 LAMOST template spectra with 61 different MK classes by combing with current library.
\end{abstract}
...
%Due to the difficulty of accurate manually classifying using so many A-type template from MILES,
...
\enddata
\tablecomments{
C1 is the amount of   templates with corresponding subclass in our constructed library.
C2 is the amount of   templates with corresponding subclass in the finally combined library.
}
\end{deluxetable}
\clearpage
...
%\setlength{\tabcolsep}{0.05in}
\tablewidth{0pt}
\tablecaption{The main information of template \#69, \#10, \#183, \#159\label{tab2}}
\tablehead{
\colhead{Template ID}&
\colhead{Group ID}&
\colhead{All spectra}&
